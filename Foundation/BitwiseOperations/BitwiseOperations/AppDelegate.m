...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    /*
     ...
     student.studiesGeography = NO;
     student.studiesHistory = NO;
    */
    
    Student* student = [Student new];

    student.subjectType = StudentSubjectTypeDevelopment | StudentSubjectTypeEngineering | StudentSubjectTypeMath;
